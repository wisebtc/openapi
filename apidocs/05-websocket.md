...
dumpScale must be specified for this endpoint. It it the precision of the ticker, it cannot be larger than the specified precision. Check precision at **[brokerInfo](03-spot.md#broker-information)** (token, options, and contracts).
